...
export default function FilmPage({ params }) {
  ...
  return (
    <main className="mx-auto max-w-3xl px-7.5">
      {/* Header and details */}
      ...
      <div className="flex flex-col sm:flex-row gap-8 justify-center items-center">
        ...
        {/* Description section */}
        <div className="grow">
          <h2 className="text-4xl font-bold text-[#EDF2F4] mb-4">
            {filmDetails?.title || "Film Title Placeholder"}
          </h2>
          <p className="text-[#EDF2F4] leading-relaxed">
            {filmDetails?.description || "Description placeholder..."}
          </p>
