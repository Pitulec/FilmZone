    ...
    const handleSignIn = async () => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                console.error("BBackend error:", data);
            }
        } catch (err) {
    ...
    return (
        <main className="flex items-center justify-center min-h-screen">
            <div className="flex flex-col bg-[#8d99ae21] outline outline-[#8D99AE] rounded-xl p-8 w-md">
                ...
                />
                {username.length > 0 && !isUsernameValid && (
                    <p className="text-sm text-[#DD4242] mb-3 -mt-2">
                        Nazwa użytkownika musi mieć od 6 do 70 znaków.
                    </p>
                )}
                ...
                />
                {password.length > 0 && !isPasswordValid && (
                    <p className="text-sm text-[#DD4242] mb-3 -mt-5">
                        Hasło musi mieć od 6 do 70 znaków.
                    </p>
                )}
                ...
                {error && (
                    <p className="text-sm text-[#DD4242] mb-3 text-center font-medium">
                        {error}
                    </p>
                )}
